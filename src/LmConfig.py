...
class PrefsDialog(QtWidgets.QDialog):
	def __init__(self, iParent = None):
		...
		# Warning: annoying PyQT bug for grid placement, workaround via this "hole" in the row numbering
		aPrefsEditGrid.addWidget(aMacAddrApiKeyLabel, 2, 0)
		aPrefsEditGrid.addWidget(self._macAddrApiKey, 2, 1, 2, 3)
		aPrefsEditGrid.addWidget(aStatsFrequencyLabel, 4, 0)
		aPrefsEditGrid.addWidget(self._statsFrequency, 4, 1)
		aPrefsEditGrid.addWidget(aPhoneCodeLabel, 4, 2)
		aPrefsEditGrid.addWidget(self._phoneCode, 4, 3)
		aPrefsEditGrid.addWidget(aListHeaderHeightLabel, 5, 0)
		aPrefsEditGrid.addWidget(self._listHeaderHeight, 5, 1)
		aPrefsEditGrid.addWidget(aListHeaderFontSizeLabel, 5, 2)
		aPrefsEditGrid.addWidget(self._listHeaderFontSize, 5, 3)
		aPrefsEditGrid.addWidget(aListLineHeightLabel, 6, 0)
		aPrefsEditGrid.addWidget(self._listLineHeight, 6, 1)
		aPrefsEditGrid.addWidget(aListLineFontSizeLabel, 6, 2)
		aPrefsEditGrid.addWidget(self._listLineFontSize, 6, 3)
