### Livebox Monitor French Language module ###
...
LABELS = {
	...
	'info': {
		...
		'Registration ID': 'ID Enregistrement',
		'Local Registration ID': 'ID Enregistrement Local',
		'Ready': 'Prêt',
		'Operating State': 'État Opérationnel',
		'Optical Signal Level': 'Niveau Signal Optique',
		'Transmit Optical Level': 'Niveau Transmission Optique',
