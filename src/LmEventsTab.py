...
class LmEvents:
	...
	def createEventsTab(self):
		...
		self._eventDList.setMinimumWidth(350 + LmConfig.SCROLL_BAR_ADJUST)
		...
		aHeader.setSectionResizeMode(EventCol.Time, QtWidgets.QHeaderView.ResizeMode.Fixed)
		aHeader.setSectionResizeMode(EventCol.Reason, QtWidgets.QHeaderView.ResizeMode.Fixed)
