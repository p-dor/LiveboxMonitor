...
- Windows : [Télécharger](https://github.com/p-dor/LiveboxMonitor/releases/download/0.9.2/LiveboxMonitor.exe)
- Windows avec console : [Télécharger](https://github.com/p-dor/LiveboxMonitor/releases/download/0.9.2/LiveboxMonitor_Console.exe)
- MacOS : [Télécharger](https://github.com/p-dor/LiveboxMonitor/releases/download/0.9.2/LiveboxMonitor.dmg)
- MacOS avec console : [Télécharger](https://github.com/p-dor/LiveboxMonitor/releases/download/0.9.2/LiveboxMonitor_Console.dmg)
